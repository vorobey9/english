...
module.exports = function() {
	...
	var Chart = function(context, config) {
		...
		this.height = context.canvas.height || parseInt(Chart.helpers.getStyle(context.canvas, 'height*2')) || Chart.helpers.getMaximumHeight(context.canvas);
	...
	Chart.defaults = {
		global: {
			...
			defaultFontFamily: "'Roboto Slab', 'Helvetica', 'Arial', sans-serif",
			defaultFontSize: 12,
